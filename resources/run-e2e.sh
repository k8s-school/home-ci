...
case "$EXPECTED_BEHAVIOR" in
    "success")
        ...
        echo "Test completed successfully" > "$DATA_DIR/SUCCESS_${TIMESTAMP}_${BRANCH_NAME}_${COMMIT_HASH}.txt"
        exit 0
        ;;
    ...
    "failure")
        ...
        echo "Test failed as expected" > "$DATA_DIR/FAILURE_${TIMESTAMP}_${BRANCH_NAME}_${COMMIT_HASH}.txt"
        exit 1
        ;;
    ...
    "timeout")
        ...
        echo "Test will timeout" > "$DATA_DIR/TIMEOUT_${TIMESTAMP}_${BRANCH_NAME}_${COMMIT_HASH}.txt"
